...
# MAGIC Databricks Runtime 7.3 (LTS)
# MAGIC r5d.12xlarge * 6
...
# dbutils.fs.mkdirs("dbfs:/mnt/fl60-ukbb-raw/downloaded/genetics/glow")
...
sample_blocks_path = '/dbfs/mnt/fl60-ukbb-raw/downloaded/genetics/glow/wgr_sample_blocks_chr21_chr22.json'
block_matrix_path = 'dbfs:/mnt/fl60-ukbb-raw/downloaded/genetics/glow/wgr_block_matrix_chr21_chr22.delta'
...
label_df = pd.read_csv(binary_phenotypes_path, dtype={'sample_id': str}, index_col='sample_id')[['disease_id']]
