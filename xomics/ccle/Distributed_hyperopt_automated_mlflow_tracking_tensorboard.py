...
# MAGIC %md ---
# MAGIC title: Applying deep learning using Spark for distributed hyperparameter tuning and automated mlflow tracking
# MAGIC authors:
# MAGIC - Maneesh Bhide
...
# MAGIC - GPU
# MAGIC - CPU
# MAGIC created_at: 2020-01-28
# MAGIC updated_at: 2020-04-05
# MAGIC tldr: MNIST with Keras, distributed Hyperopt, automated mlflow tracking, and tensorboard
# MAGIC ---
...
# MAGIC - AWS demo.cloud: [https://demo.cloud.databricks.com/#notebook/3600569](https://demo.cloud.databricks.com/#notebook/3600569)
...
log_dir_local = "/dbfs/tmp/KnowledgeRepo/distributed_hyperopt/tensorboardd"
...
# MAGIC %fs mkdirs /tmp/KnowledgeRepo/distributed_hyperopt/tensorboard
...
# MAGIC %tensorboard --logdir /dbfs/tmp/KnowledgeRepo/distributed_hyperopt/tensorboard
...
space = {
  ...
  'batch_size': hp.quniform('batch_size', 32, 128, 8),
...
# MAGIC %md
# MAGIC <img src="https://databricks-knowledge-repo-images.s3.us-east-2.amazonaws.com/HLS/mlflow_mnist_distributed_hpopt.png" width="1400" />
...
# MAGIC %md
# MAGIC <img src="https://databricks-knowledge-repo-images.s3.us-east-2.amazonaws.com/HLS/parallel_coordinates_plot_mnist_distributed_hpopt.png" width="1500" />
...
# MAGIC %md
# MAGIC <img src="https://databricks-knowledge-repo-images.s3.us-east-2.amazonaws.com/HLS/tensorboard_mnist_distributed_hpopt.png" width="600" />
