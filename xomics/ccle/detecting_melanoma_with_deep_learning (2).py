...
# MAGIC %fs cp -r dbfs:/mnt/databricks-datasets-private/HLS/ dbfs:/home/alex.barreto@databricks.com/hls-datasets/

# COMMAND ----------

# MAGIC %fs ls dbfs:/home/alex.barreto@databricks.com/hls-datasets/

# COMMAND ----------

# MAGIC %fs
# MAGIC ls dbfs:/mnt/databricks-datasets-private/HLS/
...
# MAGIC
# MAGIC ```
# MAGIC dbutils.fs.cp("file:/tmp/melanoma.pb", "dbfs:/mnt/databricks-datasets-private/HLS/melanoma/melanoma.pb", True)
# MAGIC dbutils.fs.cp('file:/tmp/retrain_logs', 'dbfs:/mnt/databricks-datasets-private/HLS/melanoma/train', True)
# MAGIC ```
...
dbutils.fs.cp("file:/tmp/melanoma.pb", "dbfs:/mnt/databricks-datasets-private/HLS/melanoma/melanoma.pb", True) 
dbutils.fs.cp('file:/tmp/retrain_logs', 'dbfs:/mnt/databricks-datasets-private/HLS/melanoma/train', True)
...
# MAGIC %tensorboard --logdir file:/tmp/retrain_logs
