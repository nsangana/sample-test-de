...
# MAGIC %sql
# MAGIC
# MAGIC set spark.databricks.conda.condaMagic.enabled=true
...
# MAGIC
# MAGIC """
# MAGIC Register docked_conformer_vina_results to Feature Store
# MAGIC """
# MAGIC
...
# MAGIC
# MAGIC # start the feature store client
# MAGIC fs = feature_store.FeatureStoreClient()
# MAGIC
# MAGIC fs.register_table(
# MAGIC   delta_table='LIGAND_DOCKING_TABLE',
# MAGIC   primary_keys='SMILES, bounding_box, ZINC_ID',
# MAGIC   description='QSAR LIGAND DOCKING TABLE'
# MAGIC )
...
# MAGIC <img src="https://raw.githubusercontent.com/bluerider/distributed_qsar/master/6cox_docked_4.png" width = "33%"><img src="https://raw.githubusercontent.com/bluerider/distributed_qsar/master/6cox_docked_3.png" width = "33%"><img src="https://raw.githubusercontent.com/bluerider/distributed_qsar/master/6cox_docked_3.png" width = "33%">
